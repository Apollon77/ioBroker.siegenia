...
const deviceSpecialObjects = {
    '3': { // DRIVE axxent Family, Seite 20
        'openclose': {read: false, write: true, type: 'number', role: 'level', states: {1: 'OPEN', 2: 'CLOSE', 3: 'OPEN_TO_TURN'}, native: {handleAsString: true}},
    ...
    '5': { // AEROVITAL ambience
        ...
        'timer.fanmode': {read: false, write: true, type: 'number', role: 'level', states: {1: 'IN', 2: 'OUT', 3: 'IN_OUT', 4: 'IN_OUT_WRG', 5: 'AUTO'}, native: {handleAsString: true}}
    },
    '6': { // MHS Family
        'sash-0.openclose': {read: false, write: true, type: 'number', role: 'level', states: {1: 'OPEN', 2: 'GAP_VENT', 3: 'STOP_OVER', 4: 'CLOSE', 5: 'CLOSE_WO_LOCK'}, native: {handleAsString: true, realId: 'openclose.0'}},
        'sash-1.openclose': {read: false, write: true, type: 'number', role: 'level', states: {1: 'OPEN', 2: 'GAP_VENT', 3: 'STOP_OVER', 4: 'CLOSE', 5: 'CLOSE_WO_LOCK'}, native: {handleAsString: true, realId: 'openclose.1'}},
